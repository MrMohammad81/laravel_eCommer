                            ...
                            <div class="ht-product-image-wrap">
                                ...
                                <div class="ht-product-action">
                                    <ul>
                                        ...
                                        <li>
                                            @auth
                                                @if($similarProduct->checkUserWishlist(auth()->id()))
                                                    <a href="{{ route('home.wishlist.remove'  , $similarProduct->id) }}"><i class="fas fa-heart" style="color: red"></i>
                                                        <span class="ht-product-action-tooltip">حذف از لیست علاقه مندی ها </span>
                                                    </a>
                                                @else
                                                    <a href="{{ route('home.wishlist.add'  , $similarProduct->id) }}"><i class="sli sli-heart"></i>
                                        ...
                                        <li>
                                            <a href="{{ route('home.compare.add' , $similarProduct->id) }}"><i class="sli sli-refresh"></i>
                                ...
                                <div class="product-details-content quickview-content">
                                    ...
                                    @if($similarProduct->QuantityCheckeProduct())
                                                ...
                                                <div class="pro-details-size w-50">
                                                    ...
                                                    <select name="variation" class="form-control variation-select">
                                                        @foreach($similarProduct->variations()->where('quantity' , '>' , 0)->get() as $variation)
                                                            <option name="variation" value="{{ json_encode($variation->only('id' , 'sale_price' , 'quantity' , 'is_sale' , 'price')) }}"
                                                                {{ $variationProductSelected->id == $variation->id ? 'selected' : '' }}
                                                            >{{ $variation->value }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="pro-details-quality">
                                                ...
                                                <div class="pro-details-compare">
                                                    <a title="Add To Compare" href="{{ route('home.compare.add' , $similarProduct->id) }}"><i class="sli sli-refresh"></i></a>
                                                </div>
                                            </div>
                                        @else
                                            <div class="not-in-stock">
