...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-4 p-md-5 bg-white">
            <div class="mb-4">
                <h5 class="font-weight-bold">بروزرسانی نقش</h5>
            </div>
            <hr>
            ...
            <form action="{{ route('admin.roles.update' , $role->id) }}" method="POST">
                                ...
                                <div class="card-body row">
                                    @foreach($permissions as $permision)
                                        <div class="form-group form-check">
                                            ...
                                            {{ in_array($permision->id , $role->permissions->pluck('id')->toArray()) ? 'checked' : '' }}>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                ...
                <button class="btn btn-outline-success mt-5" type="submit">بروزرسانی</button>
